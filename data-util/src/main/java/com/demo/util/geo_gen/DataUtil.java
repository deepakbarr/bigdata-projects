...
public class DataUtil {
    ...
    private static final String OUTPUT_FILE = "/Users/dbarr/Garbage/data/demand_data.csv";
    ...
    public static List<String> transform(List<String> rows) throws JsonProcessingException {
        ...
        for (String row : rows) {
            ...
            record = new BaseRecord(ID_PREFIX + (++Id), tokens[1], Double.parseDouble(tokens[6]), Double.parseDouble(tokens[5]),
